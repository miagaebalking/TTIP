           ...
           if(result.subService!=null){
               ...
               for(var i in selectedCategory){
                   ...
                   portfolioCategoryStr += "<div class='portfolioSelectedCategory'>"
					            		+       "<input type='radio' name='portfolioCategory' id='portfolioCategory"+i+"' value='"+selectedCategory[i]+"'>"
					            				+"<label for='portfolioCategory"+i+"'>"+selectedCategory[i]+"</label>"
					            		+	"</div>"
               }
               ...
               console.log('포트폴리오 모달 데이터',portfolioCategoryStr);
